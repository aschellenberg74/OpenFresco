...
%              'Visible','on');
%          question = axes('Parent',Struct(8),'Position',[0.925 0.8 0.05 0.1]);
%          imagesc(imread(fullfile(DIR,'Buttons','question.png')));
%          set(question,'XTick',[],'YTick',[],'Box','off','Visible','off');
...
Struct(16) = uipanel('Parent',ph_Main,...
    ...
    'Visible','off');
         ...
         Struct(15) = uicontrol(Struct(16),'Style','text',...
             ...
             'Position',[0.1 0.8 0.8 0.1],...
             'Callback','Structure(''mass_input'')');
         m2_help = uicontrol(Struct(16),'Style','text',...
             'Units','normalized',...
             'FontSize',10,...
             'String','?',...
...
Struct(24) = uipanel('Parent',ph_Main,...
    ...
    'Visible','off');
       ...
       Struct(23) = uicontrol(Struct(24),'Style','text',...
           ...
           'Position',[0.1 0.8 0.8 0.1],...
           'Callback','Structure(''mass_input'')');
       m3_help = uicontrol(Struct(24),'Style','text',...
             'Units','normalized',...
             'FontSize',10,...
             'String','?',...
             'ToolTipString',sprintf('Input a matrix of mass values\nin the form [mass1 0; 0 mass2]'),...
...
Analysis(2) = uipanel('Parent',ph_Main,...
    ...
    'Visible','off');
        ...
        dt_help = uicontrol(Analysis(2),'Style','text',...
             'Units','normalized',...
             'FontSize',10,...
             'String','?',...
