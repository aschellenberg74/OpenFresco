...
% sideBut = imresize(imread('grayBut.png'), [(sideButHeight*1.03) (sideButWidth*1.03)]);
% sideButSelect = imresize(imread('grayButSelect.png'), [sideButHeight*1.03 sideButWidth*1.03]);
Analysis0   = imresize(imread(fullfile(DIR,'Buttons','Analysis0.jpg')), [(sideButHeight) (sideButWidth)]);
Analysis1   = imresize(imread(fullfile(DIR,'Buttons','Analysis1.jpg')), [(sideButHeight) (sideButWidth)]);
ExpControl0 = imresize(imread(fullfile(DIR,'Buttons','ExpControl0.jpg')), [(sideButHeight) (sideButWidth)]);
ExpControl1 = imresize(imread(fullfile(DIR,'Buttons','ExpControl1.jpg')), [(sideButHeight) (sideButWidth)]);
ExpSetup0   = imresize(imread(fullfile(DIR,'Buttons','ExpSetup0.jpg')), [(sideButHeight) (sideButWidth)]);
ExpSetup1   = imresize(imread(fullfile(DIR,'Buttons','ExpSetup1.jpg')), [(sideButHeight) (sideButWidth)]);
Loading0    = imresize(imread(fullfile(DIR,'Buttons','Loading0.jpg')), [(sideButHeight) (sideButWidth)]);
Loading1    = imresize(imread(fullfile(DIR,'Buttons','Loading1.jpg')), [(sideButHeight) (sideButWidth)]);
Structure0  = imresize(imread(fullfile(DIR,'Buttons','Structure0.jpg')), [(sideButHeight) (sideButWidth)]);
Structure1  = imresize(imread(fullfile(DIR,'Buttons','Structure1.jpg')), [(sideButHeight) (sideButWidth)]);


analysisWidth1 = 0.8*SS(3)*0.81*0.5*0.3;
analysisHeight1 = 0.8*SS(4)*0.8*0.3*0.7;
analysisBut1 = imresize(imread(fullfile(DIR,'Buttons','grayBut.png')), [analysisHeight1*1.05 analysisWidth1*1.05]);
% startButSelect1 = imresize(imread('start.png'), [analysisHeight1*1.05 analysisWidth1*1.05]);
pauseButSelect1 = imresize(imread(fullfile(DIR,'Buttons','pause.png')), [analysisHeight1*1.05 analysisWidth1*1.05]);
stopButSelect1 = imresize(imread(fullfile(DIR,'Buttons','stop.png')), [analysisHeight1*1.05 analysisWidth1*1.05]);
Start0a = imresize(imread(fullfile(DIR,'Buttons','Start0.jpg')), [analysisHeight1 analysisWidth1]);
Start1a = imresize(imread(fullfile(DIR,'Buttons','Start1.jpg')), [analysisHeight1 analysisWidth1]);

analysisWidth2 = 0.1*SS(3)*0.94*0.84;
analysisHeight2 = 0.27*SS(4)*0.94*0.3;
analysisBut2 = imresize(imread(fullfile(DIR,'Buttons','grayBut.png')), [analysisHeight2*1.05 analysisWidth2*1.05]);
% startButSelect2 = imresize(imread('start.png'), [analysisHeight2*1.05 analysisWidth2*1.05]);
pauseButSelect2 = imresize(imread(fullfile(DIR,'Buttons','pause.png')), [analysisHeight2*1.05 analysisWidth2*1.05]);
stopButSelect2 = imresize(imread(fullfile(DIR,'Buttons','stop.png')), [analysisHeight2*1.05 analysisWidth2*1.05]);
Start0b = imresize(imread(fullfile(DIR,'Buttons','Start0.jpg')), [analysisHeight2 analysisWidth2]);
Start1b = imresize(imread(fullfile(DIR,'Buttons','Start1.jpg')), [analysisHeight2 analysisWidth2]);

questWidth = SS(4)*0.8*0.8*0.35*0.1;
questHeight = SS(3)*0.8*0.81*0.32*0.07;
question = imresize(imread(fullfile(DIR,'Buttons','question.png')),[questHeight questWidth]);
...
% imagesc(imread(fullfile(DIR,'Buttons','greyGradient.png')));
imagesc(imread(fullfile(DIR,'Buttons','Metal.jpg')));
...
Sidebar(1) = uibuttongroup('Parent',f,...
    ...
    'Position',[0.03 .4 .1 .5]);
         ...
         Sidebar(11) = uicontrol(Sidebar(1),'Style','togglebutton',...
             ...
             'CData',Analysis0);
         align(Sidebar(7:11),'None','Fixed',12);
...
Sidebar(2) = uicontrol('Parent',f,...
    ...
    'Position',[0.03 0.35 0.1 0.03]);

% Sidebar(3) = uibuttongroup('Parent',f,...
%     'BackgroundColor',panel_color,...
%     'Visible','off',...
%     'Position',[0.03 .1 .1 .23]);
...
Struct(1) = uicontrol(ph_Main,'Style','text',...
    ...
    'BackgroundColor',panel_color,...
    'Position',[0.3 0.92 0.4 0.06],...
    'FontName',font,...
    'Visible','off');                      

%Image Button Group     
% Struct(31) = uipanel('Parent',ph_Main,...
%     'Position',[0.05 0.03 0.9 0.89],...
%     'Visible','off');
% Background = axes('Parent',Struct(31),'Position',[0 0 1 1]);
% imagesc(imread(fullfile(DIR,'Buttons','greyGradient.png')));
% % imagesc(imread(fullfile(DIR,'Buttons','Metal.jpg')));
% set(Background,'XTick',[],'YTick',[]); 

BackgroundPanel = uipanel('Parent',ph_Main,...
    'Position',[0.05 0.02 0.9 0.9],...
    'Visible','on');
...
%          set(Background,'XTick',[],'YTick',[]);
         ...
         Struct(7) = uicontrol(Struct(8),'Style','text',...
             'Units','normalized',...
             'FontSize',10,...
         ...
         m1_help = uicontrol(Struct(8),'Style','pushbutton',...
             ...
             'Position',[0.92 0.8 0.07 0.1],...
             'Visible','on',...
             'CData',question);

%          m1_help = uicontrol(Struct(8),'Style','text',...
%              'Units','normalized',...
%              'FontSize',10,...
%              'String','?',...
%              'ToolTipString','Input a numeric mass value',...
%              'Position',[0.925 0.8 0.05 0.1],...
%              'Visible','on');

%          Background = axes('Parent',ph_Main,'Position',[(0.34+0.32*0.925) (0.05+0.35*0.8) 0.32*0.05 0.35*0.1]);
%          imagesc(imread('question.png'));
%          set(Background,'XTick',[],'YTick',[],'Box','off','Visible','off');
...
Struct(16) = uipanel('Parent',ph_Main,...
    'Position',[0.34 0.05 0.32 0.35],...
    'Visible','off');
         st_Struct_m2A = uicontrol(Struct(16),'Style','text',...
             'Units','normalized',...
             'FontSize',10,...
             'String','M',...
             'Position',[0.025 0.8 0.05 0.1]);
...
Struct(24) = uipanel('Parent',ph_Main,...
    'Position',[0.34 0.05 0.32 0.35],...
    'Visible','off');
       st_Struct_m2B = uicontrol(Struct(24),'Style','text',...
           'Units','normalized',...
           'FontSize',10,...
           'String','M',...
           'Position',[0.025 0.8 0.05 0.1]);
...
%     'Position',[0.05 0.02 0.9 0.9],...
%     'Visible','off');
% Background = axes('Parent',GM(18),'Position',[0 0 1 1]);
% imagesc(imread(fullfile(DIR,'Buttons','greyGradient.png')));
% % imagesc(imread(fullfile(DIR,'Buttons','Metal.jpg')));
% set(Background,'XTick',[],'YTick',[]); 
...
GM(2) = uipanel('Parent',GM(18),...
    ...
    'Visible','off');
         ...
         st_GM_Xscale = uicontrol(GM(2),'Style','text',...
             ...
             'FontSize',10,...
             'FontWeight','bold',...
             'Position',[0.15 0.5 0.8 0.1]);
         st_GM_Xamp = uicontrol(GM(2),'Style','text',...
             'Units','normalized',...
             'String','Amplitude',...
             'Position',[0.01 0.35 0.2 0.1]);
         GM(4) = uicontrol(GM(2),'Style','edit',...
             'Units','normalized',...
             'String','386.1',...
             'BackgroundColor',[1 1 1],...
             'Tag','edit_amp1',...
             'Position',[0.25 0.35 0.56 0.15],...
         ...
         agScale_help = uicontrol(GM(2),'Style','pushbutton',...
             ...
             'Position',[0.85 0.35 0.09 0.16],...
             'CData',question);
         st_GM_Xdt = uicontrol(GM(2),'Style','text',...
             'Units','normalized',...
             'String','Time',...
             'Position',[0.03 0.17 0.125 0.1]);
         GM(5) = uicontrol(GM(2),'Style','edit',...
             'Units','normalized',...
             'String','1',...
             'BackgroundColor',[1 1 1],...
             'Tag','edit_time1',...
             'Position',[0.25 0.17 0.56 0.15],...
             'Callback','GroundMotions(''scale'')');
         GM(6) = uicontrol(GM(2),'Style','pushbutton',...
             ...
             'Callback','GroundMotions(''scale'')');
         GM(7) = axes('Parent',GM(18),'Position',[0.12 0.45 0.35 0.15],'Box','on',...
...
GM(10) = uipanel('Parent',GM(18),...
    ...
    'Visible','off');
         ...
         GM(14) = uicontrol(GM(10),'Style','pushbutton',...
             ...
             'Position',[0.33 0.01 0.4 0.15],...
             'Callback','GroundMotions(''scale'')');
         GM(15) = axes('Parent',GM(18),'Position',[0.56 0.45 0.35 0.15],'Box','on',...
...
% handles.Store.sideBut = sideBut;
% handles.Store.sideButSelect = sideButSelect;
handles.Store.analysisWidth1 = analysisWidth1;
handles.Store.analysisHeight1 = analysisHeight1;
handles.Store.analysisBut1 = analysisBut1;
% handles.Store.startButSelect1 = startButSelect1;
handles.Store.Start0a = Start0a;
handles.Store.Start1a = Start1a;
handles.Store.pauseButSelect1 = pauseButSelect1;
handles.Store.stopButSelect1 = stopButSelect1;
handles.Store.analysisWidth2 = analysisWidth2;
handles.Store.analysisHeight2 = analysisHeight2;
handles.Store.analysisBut2 = analysisBut2;
% handles.Store.startButSelect2 = startButSelect2;
handles.Store.Start0b = Start0b;
handles.Store.Start1b = Start1b;
handles.Store.pauseButSelect2 = pauseButSelect2;
handles.Store.stopButSelect2 = stopButSelect2;
        ...
        switch Page_selection;
            ...
            case 'Loading'
                ...
                elseif strcmp(handles.Model.Type, '2 DOF B') ~= 1
                    ...
                    set(handles.GroundMotions([1:9 18:20]),'Visible','on');
                    ...
                    set(findobj('Tag','GMhelp'),'Position',[0.85 0.66 0.05 0.16]);
                    set(findobj('Tag','Scalehelp'),'Position',[0.85 0.33 0.05 0.16]);
                else
                    set(handles.GroundMotions,'Visible','on');
                    set(handles.GroundMotions(2),'Position',[0.12 0.64 0.35 0.33]);
                    set(handles.GroundMotions(7),'Position',[0.12 0.45 0.35 0.15]);
                    set(handles.GroundMotions(8),'Position',[0.12 0.25 0.35 0.15]);
                    set(handles.GroundMotions(9),'Position',[0.12 0.08 0.35 0.15]);
                    set(findobj('Tag','GMhelp'),'Position',[0.85 0.7 0.09 0.16]);
                    set(findobj('Tag','Scalehelp'),'Position',[0.85 0.35 0.09 0.16]);
                end
