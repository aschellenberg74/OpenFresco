...
a_StructuralOutput_dX = axes('Parent',f_StructOut1,...
    ...
    'Position',[0.06 0.69 0.56 0.15],'XTickLabel',[],...
    'XLimMode','manual','Xlim',[0.0 tEnd]);
grid('on');
ylabel(a_StructuralOutput_dX,'d (in.)');
a_StructuralOutput_fX = axes('Parent',f_StructOut1,...
    'Tag','SO1f',...
    'NextPlot','replacechildren',...
    'Position',[0.06 0.49 0.56 0.15],'XTickLabel',[],...
    'XLimMode','manual','Xlim',[0.0 tEnd]);
grid('on');
ylabel(a_StructuralOutput_fX,'f (k)');
a_StructuralOutput_aX = axes('Parent',f_StructOut1,...
    'Tag','SO1a',...
    'NextPlot','replacechildren',...
    'Position',[0.06 0.29 0.56 0.15],'XTickLabel',[],...
    'XLimMode','manual','Xlim',[0.0 tEnd]);
grid('on');
ylabel(a_StructuralOutput_aX,'a (in./s^2)');
a_StructuralOutput_agX = axes('Parent',f_StructOut1,...
    'Tag','SO1ag',...
    'NextPlot','replacechildren',...
    'Position',[0.06 0.09 0.56 0.15]);
line(handles.GM.scalet{1}, handles.GM.scaleag{1});
grid('on');
ylabel(a_StructuralOutput_agX,'ag (in./s^2)');
xlabel(a_StructuralOutput_agX,'Time (s)');
a_StructuralOutput_fdX = axes('Parent',f_StructOut1,...
    'Tag','SO1fd',...
    'NextPlot','replacechildren',...
    'Position',[0.68 0.09 0.3 0.75]);
grid('on');
xlabel(a_StructuralOutput_fdX,'d (in.)');
ylabel(a_StructuralOutput_fdX,'f (k)');
if ~strcmp(handles.Model.Type, '1 DOF')
    ...
    a_StructuralOutput_dd = axes('Parent',f_StructOut1,...
        'Tag','SO1dd',...
        'NextPlot','replacechildren',...
        'Position',[0.68 0.08 0.31 0.33]);
    grid('on');
    xlabel(a_StructuralOutput_dd,'d1 (in.)');
    ylabel(a_StructuralOutput_dd,'d2 (in.)');
end
...
if ~strcmp(handles.Model.Type, '1 DOF')
    ...
    a_StructuralOutput_dY = axes('Parent',f_StructOut2,...
        ...
        'XLimMode','manual','Xlim',[0.0 tEnd]);
    grid('on');
    ylabel(a_StructuralOutput_dY,'d (in.)');
    a_StructuralOutput_fY = axes('Parent',f_StructOut2,...
        ...
        'XLimMode','manual','Xlim',[0.0 tEnd]);
    grid('on');
    ylabel(a_StructuralOutput_fY,'f (k)');
    a_StructuralOutput_aY = axes('Parent',f_StructOut2,...
        ...
        'XLimMode','manual','Xlim',[0.0 tEnd]);
    grid('on');
    ylabel(a_StructuralOutput_aY,'a (in./s^2)');
    axes('Parent',f_StructOut2,...
        'Tag','SO2ag',...
        'NextPlot','replacechildren',...
        'Position',[0.06 0.09 0.56 0.15]);
    ...
    a_StructuralOutput_fdY = axes('Parent',f_StructOut2,...
        'Tag','SO2fd',...
        'NextPlot','replacechildren',...
        'Position',[0.68 0.52 0.31 0.33]);
    grid('on');
    xlabel(a_StructuralOutput_fdY,'d (in.)');
    ylabel(a_StructuralOutput_fdY,'f (k)');
    a_StructuralOutput_ff = axes('Parent',f_StructOut2,...
        'Tag','SO2ff',...
        'NextPlot','replacechildren',...
        'Position',[0.68 0.08 0.31 0.33]);
    grid('on');
    xlabel(a_StructuralOutput_ff,'f1 (k)');
    ylabel(a_StructuralOutput_ff,'f2 (k)');
