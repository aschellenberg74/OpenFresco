...
if {$withGravity} {
    ...
    recorder Element -file GravityLinAlg_Elmt_ctrlDsp.out -time -ele 1 2   ctrlDisp
    recorder Element -file GravityLinAlg_Elmt_daqDsp.out  -time -ele 1 2   daqDisp
    expRecorder Control -file GravityLinAlg_Ctrl_ctrlDsp.out -time -control 1 2 ctrlDisp
    expRecorder Control -file GravityLinAlg_Ctrl_daqDsp.out  -time -control 1 2 daqDisp
    expRecorder Control -file GravityLinAlg_Ctrl_daqFrc.out  -time -control 1 2 daqForce
    # --------------------------------
