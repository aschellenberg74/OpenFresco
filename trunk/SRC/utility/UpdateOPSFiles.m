...
% update OpenSees library files (base folder)
fprintf(1,'Added OpenSees LIB folders to path.\n\n');
...
% update OpenSees library files (debug folder)
...
% update OpenSees library files (release folder)
...
rmpath(pathOPSlib);
fprintf(1,'Finished updating OpenSees LIB files in OpenFresco.\n\n');
fprintf(1,'Removed OpenSees LIB folders from path.\n');
