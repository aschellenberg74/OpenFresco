...
# ------------------------------
ops.logFile("OneBayFrame_Local_SimAppServer.log")
...
ops.startSimAppElemServer(1, 8090, "-udp");  # use with generic client element in FEA

# startSimAppSiteServer(siteTag, port, <"-ssl",> <"-udp">)
#ops.startSimAppSiteServer(1, 8090, "-udp");  # use with experimental element in FEA
