...
socketType = 'UDPSocket';   % choose UDPSocket or TCPSocket
...
ElementData(1).socketType = socketType;   %Socket type: UDPSocket or TCPSocket
...
%ElementData(2).socketType = socketType;  %Socket type: UDPSocket or TCPSocket
...
%ElementData(3).socketType = socketType;  %Socket type: UDPSocket or TCPSocket
...
legend('Element 1','Element 2','Location','NorthWest')
title(['Hysteresis Loops: Explicit Newmark, beta = ',num2str(beta),', gamma = ',num2str(gamma)])
grid on
...
xlabel('Time [sec]')
legend('DOF 1','DOF 2','Location','NorthEast')
title(['Displacement Histories: Explicit Newmark, beta = ',num2str(beta),', gamma = ',num2str(gamma)])
grid on
