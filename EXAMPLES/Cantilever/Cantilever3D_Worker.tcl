# File: Cantilever3D_Worker.tcl (use with Cantilever3D_Main.tcl)
# Units: [kip,in.]
#
...
# ------------------------------
logFile "Cantilever3D_Worker.log"
...
uniaxialMaterial Elastic 3 [expr 1000.0*11154]
...
element adapter 2 -node 2 -dof 1 2 -stif 1E5 0 0 1E5 44000
# ------------------------------
