# File: Cantilever3D_Main.tcl (use with Cantilever3D_Worker.tcl)
# Units: [kip,in.]
#
...
expSetup NoTransformation 1 -control 1 -dof 2 4 -sizeTrialOut 6 6 -ctrlDispFact -1.0 1.0 -daqDispFact -1.0 1.0 -daqForceFact -1.0 1.0
