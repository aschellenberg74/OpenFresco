# File: LShapedColumn_Client2.tcl
# (use with LShapedColumn_Server2a.tcl or LShapedColumn_Server2b.tcl)
# Units: [kip,in.]
#
...
# ------------------------------
logFile "LShapedColumn_Client2.log"
...
node  1     0.0   0.0    0.0
node  2     0.0   0.0   54.0  -mass $mass2 $mass2 $mass2 0.0 0.4 0.4
node  3    36.0   0.0   54.0  -mass $mass3 $mass3 $mass3 0.0 0.1 0.1
...
expElement beamColumn 1 1 2 1 -site 1 -initStif 1213 0 0 0 0 0  0 11.2 -302.4 0 0 0  0 -302.4 10886.4 0 0 0  0 0 0 11.2 302.4 0  0 0 0 302.4 10886.4 0  0 0 0 0 0 1E8

# Define numerical element
# ------------------------
# element elasticBeamColumn $eleTag $iNode $jNode $A $E $G $J $Iy $Iz $transfTag
element elasticBeamColumn 2 2 3 2.26 29000 11154 1E8 5.067806896551724 5.067806896551724 1
...
recorder Node -file Node_Dsp.out -time -node 2 3 -dof 1 3 5 disp
recorder Node -file Node_Vel.out -time -node 2 3 -dof 1 3 5 vel
recorder Node -file Node_Acc.out -time -node 2 3 -dof 1 3 5 accel
