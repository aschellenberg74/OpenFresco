function GUI_Main(varargin)
%GUI_MAIN to define the layout of the main GUI window
% GUI_Main(varargin)
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Setup Layout of Main GUI Window 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
metalJPG = imread(which('Metal.jpg'));
imagesc(metalJPG);
...
Menu(7) = uimenu(Menu(5),'Position',2,'Label','Copyright & Disclaimer', ...
    'Callback','OpenFrescoExpress(''about'')');
Menu(8) = uimenu(Menu(5),'Position',3,'Label','Hybrid Simulation', ...
    'Callback','Links(''Hybrid Simulation'')');
Menu(9) = uimenu(Menu(5),'Position',4,'Label','OpenFresco', ...
    'Callback','Links(''OpenFresco'')');
...
Sidebar(11) = uicontrol(Sidebar(1),'Style','togglebutton',...
    ...
    'CData',Analysis0);
set(Sidebar(1),'SelectionChangeFcn',@main_toggle_Callback);
...
uicontrol('Parent',f,...
    ...
    'Units','normalized',...
    'FontName',font,...
    'Position',[0.93 0.00 0.07 0.02],...
    'CData',metalJPG,...
    'String',['Version ',verNum{1}{1}],...
    'Callback','SplashScreen(''about'')');
...
% add slider for choosing structure
Struct(2) = uicontrol('Parent',ph_Main,...
    'Style','slider',...
    'Units','normalized',...
...
% display structure type options
Struct(3) = uibuttongroup('Parent',ph_Main,...
    'BackgroundColor',panel_color,...
    'Position',[0.34 .45 .32 .45],...
    'Visible','off');
Struct(4) = uicontrol(Struct(3),'Style','togglebutton',...
    'Tag','1 DOF',...
    'Units','normalized',...
    'Position',[0 0 1 1],...
    'CData',Model1A1);
Struct(5) = uicontrol(Struct(3),'Style','togglebutton',...
    'Tag','2 DOF A',...
    'Units','normalized',...
    'Position',[0 0 1 1],...
    'CData',Model2A0);
Struct(6) = uicontrol(Struct(3),'Style','togglebutton',...
    'Tag','2 DOF B',...
    'Units','normalized',...
    'Position',[0 0 1 1],...
    'CData',Model2B0);
set(Struct(3),'SelectionChangeFcn','Structure(''choose DOF'')');

%===============
% 1 DOF Options
%===============
Struct(7) = uipanel('Parent',ph_Main,...
...
Struct(10) = uicontrol(Struct(8),'Style','edit',...
    'Units','normalized',...
    'FontSize',10,...
    'String','',...
    'BackgroundColor',[1 1 1],...
...
Damp1_help = uicontrol(Struct(8),'Style','pushbutton',...
    ...
    'FontSize',10,...
    'Tag','help1',...
    'ToolTipString',sprintf('Input damping value as a decimal.\nFor example type 0.05 for 5%% damping.'),...
...
Struct(14) = uipanel('Parent',ph_Main,...
    'Position',[0.34 0.35 0.32 0.05],...
    'Visible','off');
Struct(15) = uipanel('Parent',ph_Main,...
    'Position',[0.34 0.1 0.32 0.3],...
    'BackgroundColor',panelDefault,...
    'Visible','off');
st_Struct_m2A1 = uicontrol(Struct(15),'Style','text',...
    'Units','normalized',...
    'FontSize',10,...
    'String','m1',...
    'BackgroundColor',panelDefault,...
    'Position',[0.015 0.8 0.07 0.1]);
Struct(16) = uicontrol(Struct(15),'Style','text',...
    'Units','normalized',...
    'FontSize',10,...
    'String','',...
    'BackgroundColor',panelDefault,...
    ...
    'Callback','Structure(''mass_input'')');
st_Struct_m2A2 = uicontrol(Struct(15),'Style','text',...
    'Units','normalized',...
    'FontSize',10,...
    'String','m2',...
    'BackgroundColor',panelDefault,...
    'Position',[0.465 0.8 0.07 0.1]);
Struct(17) = uicontrol(Struct(15),'Style','text',...
    'Units','normalized',...
    'FontSize',10,...
    'String','',...
    'BackgroundColor',panelDefault,...
    ...
    'Callback','Structure(''mass_input'')');
m2_help = uicontrol(Struct(15),'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',10,...
    'Tag','help2A',...
    ...
    'CData',Question0,...
    'Callback',@helpCallback);
st_Struct_k2A1 = uicontrol(Struct(15),'Style','text',...
    'Units','normalized',...
    'FontSize',10,...
    'String','k1',...
    'BackgroundColor',panelDefault,...
...
Struct(18) = uicontrol(Struct(15),'Style','text',...
    'Units','normalized',...
    'FontSize',10,...
    'String','',...
    'BackgroundColor',panelDefault,...
    ...
    'Callback','Structure(''stiffness_input'')');
st_Struct_k2A2 = uicontrol(Struct(15),'Style','text',...
    'Units','normalized',...
    'FontSize',10,...
    'String','k2',...
    'BackgroundColor',panelDefault,...
    'Position',[0.465 0.6 0.07 0.1]);
Struct(19) = uicontrol(Struct(15),'Style','text',...
    'Units','normalized',...
    'FontSize',10,...
    'String','',...
    'BackgroundColor',panelDefault,...
    ...
    'Callback','Structure(''stiffness_input'')');
k2_help = uicontrol(Struct(15),'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',10,...
    'Tag','help2A',...
    ...
    'CData',Question0,...
    'Callback',@helpCallback);
Struct(20) = uicontrol(Struct(15),'Style','text',...
    'Units','normalized',...
    'FontSize',10,...
    'String','Period',...
    'BackgroundColor',panelDefault,...
    'Position',[0.1 0.4 0.8 0.1]);
Struct(21) = uicontrol(Struct(15),'Style','popupmenu',...
    ...
    'Position',[0.1 0.23 0.8 0.1],...
    'Callback','Structure(''choose damping'')');
Struct(22) = uicontrol(Struct(15),'Style','text',...
    'Units','normalized',...
    'FontSize',10,...
    'String','zeta',...
    'BackgroundColor',panelDefault,...
    'Position',[0.1 0.05 0.8 0.1],...
    'Callback','Structure(''damping_input'')');
Damp2_help = uicontrol(Struct(15),'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',10,...
    'Tag','help2A',...
...
% 2 DOF B Options
%=================
Struct(23) = uipanel('Parent',ph_Main,...
    'Position',[0.34 0.35 0.32 0.05],...
    'Visible','off');
...
st_Struct_m2Bb = uicontrol(Struct(24),'Style','text',...
    ...
    'BackgroundColor',panelDefault,...
    'Position',[0.465 0.8 0.07 0.1]);
Struct(26) = uicontrol(Struct(24),'Style','text',...
    'Units','normalized',...
    'FontSize',10,...
    'String','',...
    'BackgroundColor',panelDefault,...
...
st_Struct_k2Bb = uicontrol(Struct(24),'Style','text',...
    ...
    'BackgroundColor',panelDefault,...
    'Position',[0.465 0.6 0.07 0.1]);
Struct(28) = uicontrol(Struct(24),'Style','text',...
    'Units','normalized',...
    'FontSize',10,...
    'String','',...
    'BackgroundColor',panelDefault,...
...
Struct(29) = uicontrol(Struct(24),'Style','text',...
    ...
    'BackgroundColor',panelDefault,...
    'Position',[0.1 0.4 0.8 0.1]);
Struct(30) = uicontrol(Struct(24),'Style','popupmenu',...
    'String',{'Damping Type: ','Stiffness Proportional','Mass Proportional','Rayleigh'},...
    'Value',1,...
    'Units','normalized',...
    'FontSize',10,...
    ...
    'Position',[0.1 0.23 0.8 0.1],...
    'Callback','Structure(''choose damping'')');
Struct(31) = uicontrol(Struct(24),'Style','text',...
    'Units','normalized',...
    'FontSize',10,...
    'String','zeta',...
    'BackgroundColor',panelDefault,...
...
GM(16) = uipanel('Parent',ph_Main,...
    'Visible','off',...
    'BackgroundColor',panelDefault,...
    'Position',[0.15 0.1 0.7 0.72]);

% tab buttons
GM(17) = uicontrol(ph_Main,'Style','togglebutton',...
    'Tag','Ground Motions',...
    'Units','normalized',...
    'Value',1,...
    ...
    'CData',GM1);
GM(18) = uicontrol(ph_Main,'Style','togglebutton',...
...
GM(26) = uicontrol(GM(2),'Style','text',...
    'Units','normalized',...
    'String','...',...
    'BackgroundColor',panelDefault,...
    'Tag','dt1',...
...
sty = uicontrol(GM(9),'Style','text',...
    ...
    'BackgroundColor',panelDefault,...
    'Position',[0.45 0.88 0.15 0.1]);
st_GM_Yfile = uicontrol(GM(9),'Style','text',...
    'Units','normalized',...
    'String','File',...
    'BackgroundColor',panelDefault,...
    'Position',[0.03 0.75 0.1 0.1]);
GM(10) = uicontrol(GM(9),'Style','edit',...
    'Units','normalized',...
    'String','...',...
    'BackgroundColor',[1 1 1],...
    'Tag','GM(10)',...
    'Position',[0.25 0.72 0.43 0.15],...
    'Callback','GroundMotions(''manual load'')');
pbh_GM_Ybrowse = uicontrol(GM(9),'Style','pushbutton',...
    'Units','normalized',...
    'String','...',...
    'Tag','pbh_GM_Ybrowse',...
    'Position',[0.71 0.72 0.1 0.15],...
    'Callback','GroundMotions(''load'')');
GM_help = uicontrol(GM(9),'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',10,...
    'Tag','GMhelp',...
    'ToolTipString',sprintf('You can click on this button to find\nground motions from PEER or CESMD,\nor you can upload your own file.\nNote that unrecognized formats require\nthe time step to be input manually.'),...
    ...
    'CData',Question1,...
    'Callback','Links(''GM'')');
st_dty = uicontrol(GM(9),'Style','text',...
    'Units','normalized',...
    'String','dt',...
    'BackgroundColor',panelDefault,...
    'Position',[0.03 0.56 0.1 0.1]);
GM(26) = uicontrol(GM(9),'Style','text',...
    'Units','normalized',...
    'String','...',...
    'BackgroundColor',panelDefault,...
    'Tag','dt2',...
...
% divide frame
Height = 0.005;
uicontrol(GM(9),'Style','frame', ...
    'Units','normalized', ...
    'BackgroundColor',[0 0 0],...
    'ForegroundColor',[0 0 0],...
    'Position',[0.00 0.5 1.00 Height]);
st_GM_Yscale = uicontrol(GM(9),'Style','text',...
    'Units','normalized',...
    'String','Scale Factors',...
    'FontSize',10,...
    'FontWeight','bold',...
    'BackgroundColor',panelDefault,...
    'Position',[0.15 0.35 0.8 0.1]);
st_GM_Yamp = uicontrol(GM(9),'Style','text',...
    'Units','normalized',...
    'String','Amplitude',...
    'BackgroundColor',panelDefault,...
    'Position',[0.01 0.2 0.2 0.1]);
GM(11) = uicontrol(GM(9),'Style','edit',...
    'Units','normalized',...
    'String','1.0',...
    'BackgroundColor',[1 1 1],...
    'Tag','edit_amp2',...
    'Position',[0.25 0.2 0.56 0.15],...
    'Callback','GroundMotions(''scale'')');
agScale_help = uicontrol(GM(9),'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',10,...
    'Tag','Scalehelp',...
    'ToolTipString',sprintf('The ground motion record is automatically\nscaled by gravity in units of in/s^2.'),...
    'Position',[0.85 0.2 0.083 0.132],...
    'CData',Question1,...
    'Callback',@helpCallback);
st_GM_Ydt = uicontrol(GM(9),'Style','text',...
    'Units','normalized',...
    'String','Time',...
    'BackgroundColor',panelDefault,...
    'Position',[0.03 0.02 0.125 0.1]);
GM(12) = uicontrol(GM(9),'Style','edit',...
    'Units','normalized',...
    'String','1.0',...
    'BackgroundColor',[1 1 1],...
    'Tag','edit_time2',...
    'Position',[0.25 0.02 0.56 0.15],...
    'Callback','GroundMotions(''scale'')');
GM(13) = axes('Parent',GM(16),'Position',[0.56 0.47 0.35 0.15],'Box','on',...
    'Tag','a_GM_Yag','Visible','off','NextPlot','replacechildren',...
    'ButtonDownFcn','DisplayAxes(''ag2'')','FontWeight','bold');
grid('on');
xlabel(GM(13),'Time [sec]');
ylabel(GM(13),'ag [L/sec^2]');
GM(14) = axes('Parent',GM(16),'Position',[0.56 0.25 0.35 0.15],'Box','on',...
    'Tag','a_GM_YSa','Visible','off','XTickLabel',[],'NextPlot','replacechildren',...
    'ButtonDownFcn','DisplayAxes(''Sa2'')','FontWeight','bold');
grid('on');
ylabel(GM(14),'Sa [L/sec^2]');
GM(15) = axes('Parent',GM(16),'Position',[0.56 0.08 0.35 0.15],'Box','on',...
    'Tag','a_GM_YSd','Visible','off','NextPlot','replacechildren',...
    'ButtonDownFcn','DisplayAxes(''Sd2'')','FontWeight','bold');
grid('on');
xlabel(GM(15),'Period [sec]');
ylabel(GM(15),'Sd [L]');

%============================
% Initial Conditions Options
%============================
GM(19) = uipanel('Parent',ph_Main,...
    'Visible','off',...
    'BackgroundColor',panelDefault,...
    'Position',[0.15 0.1 0.7 0.72]);
GM(20) = uipanel('Parent',GM(19),...
    'Position',[0.2 0.64 0.6 0.33],...
    'Tag','Initial Conditions',...
    'BackgroundColor',panelDefault,...
    'Visible','off');
stID = uicontrol(GM(20),'Style','text',...
    'Units','normalized',...
    'String','Initial Displacement',...
    'BackgroundColor',panelDefault,...
    'Position',[0.03 0.67 0.23 0.13]);
GM(25) = uicontrol(GM(20),'Style','popupmenu',...
    'Units','normalized',...
...
GM(21) = uicontrol(GM(20),'Style','edit',...
    'Units','normalized',...
...
stRT = uicontrol(GM(20),'Style','text',...
    'Units','normalized',...
    'String','Ramp Time',...
    'BackgroundColor',panelDefault,...
    'Position',[0.03 0.42 0.15 0.1]);
GM(22) = uicontrol(GM(20),'Style','edit',...
    'Units','normalized',...
    'String','',...
    'BackgroundColor',[1 1 1],...
    'Tag','GM(24)',...
...
stVT = uicontrol(GM(20),'Style','text',...
    'Units','normalized',...
    'String','Free Vibration Time',...
    'BackgroundColor',panelDefault,...
    'Position',[0.03 0.1 0.23 0.13]);
GM(23) = uicontrol(GM(20),'Style','edit',...
    'Units','normalized',...
    'String','',...
    'BackgroundColor',[1 1 1],...
    'Tag','GM(25)',...
...
GM(24) = uipanel('Parent',GM(19),'Position',[0.2 0.03 0.6 0.58],...
    'Tag','ICplot','Visible','off');
ICimage = axes('Parent',GM(24),'Position',[0 0 1 1]);
imagesc(imread(which('FreeVibration.png')));
set(ICimage,'XTick',[],'YTick',[]);
InitDispHelp = uicontrol(GM(20),'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',10,...
    ...
    'CData',Question1,...
    'Callback',@helpCallback);
RampHelp = uicontrol(GM(20),'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',10,...
    ...
    'CData',Question1,...
    'Callback',@helpCallback);
VibHelp = uicontrol(GM(20),'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',10,...
...
ExpControl(10) = uicontrol(ExpControl(7),'Style','popupmenu',...
    ...
    'FontSize',10,...
    'BackgroundColor',[1 1 1],...
    'String',{'Material Type...','Elastic','Elastic-Perfectly Plastic','Steel - Bilinear','Steel - Giuffre-Menegotto-Pinto'},...
...
Analysis(16) = uicontextmenu;
uimenu(Analysis(16),'Label','Explicit Newmark','Checked','on','Callback','Analysis(''set integrator'')');
uimenu(Analysis(16),'Label','Alpha OS','Callback','Analysis(''set integrator'')');
...
dt_help = uicontrol(Analysis(2),'Style','pushbutton',...
    ...
    'CData',Question1,...
    'Callback',@helpCallback);
tcl_context = uicontextmenu;
uimenu(tcl_context,'Label','Show TCL File','Callback','Analysis(''show tcl file'')');
...
animate_help = uicontrol(Analysis(13),'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',10,...
    'ToolTipString',sprintf('If this option is selected, an animation\nof the structural model will be shown\nduring the analysis.'),...
...
% add "run new test" and "quit" buttons
...
handles.GM.dt = [];
handles.GM.t = cell(1,2);
handles.GM.ag = cell(1,2);
handles.GM.scaledt = [];
handles.GM.scalet = cell(1,2);
handles.GM.scaleag = cell(1,2);
handles.GM.Spectra = cell(1,2);
...
set(handles.Structure(1:3),'Visible','on');
...
function main_toggle_Callback(source,~)
            ...
            switch handles.GM.loadType
                case 'Ground Motions'
                    if strcmp(handles.Model.Type, '2 DOF B') ~= 1
                        ...
                        set(handles.GroundMotions([1:8 16:18 26]),'Visible','on');
                        set(handles.GroundMotions(2),'Position',[0.2 0.64 0.6 0.33]);
                        set(handles.GroundMotions(6),'Position',[0.2 0.47 0.6 0.15]);
                        set(handles.GroundMotions(7),'Position',[0.2 0.25 0.6 0.15]);
                        set(handles.GroundMotions(8),'Position',[0.2 0.08 0.6 0.15]);
                        set(handles.GroundMotions(9:15),'Visible','off')
                        set(get(handles.GroundMotions(13),'Children'),'Visible','off');
                        set(get(handles.GroundMotions(14),'Children'),'Visible','off');
                        set(get(handles.GroundMotions(15),'Children'),'Visible','off');
                        ...
                        set(handles.GroundMotions([1:18 26 27]),'Visible','on');
                ...
                case 'Initial Conditions'
                    ...
                    set(handles.GroundMotions(16:25),'Visible','on');
                    set(get(handles.GroundMotions(6),'Children'),'Visible','off');
                    set(get(handles.GroundMotions(7),'Children'),'Visible','off');
                    set(get(handles.GroundMotions(8),'Children'),'Visible','off');
                    set(get(handles.GroundMotions(14),'Children'),'Visible','off');
