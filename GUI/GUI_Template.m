...
analysisBut1 = imresize(imread('grayBut.png'), [analysisHeight1*1.05 analysisWidth1*1.05]);
startButSelect1 = imresize(imread('start.png'), [analysisHeight1*1.05 analysisWidth1*1.05]);
pauseButSelect1 = imresize(imread('pause.png'), [analysisHeight1*1.05 analysisWidth1*1.05]);
stopButSelect1 = imresize(imread('stop.png'), [analysisHeight1*1.05 analysisWidth1*1.05]);

analysisWidth2 = 0.1*SS(3)*0.94*0.84;
analysisHeight2 = 0.27*SS(4)*0.94*0.3;
analysisBut2 = imresize(imread('grayBut.png'), [analysisHeight2*1.05 analysisWidth2*1.05]);
startButSelect2 = imresize(imread('start.png'), [analysisHeight2*1.05 analysisWidth2*1.05]);
pauseButSelect2 = imresize(imread('pause.png'), [analysisHeight2*1.05 analysisWidth2*1.05]);
stopButSelect2 = imresize(imread('stop.png'), [analysisHeight2*1.05 analysisWidth2*1.05]);
...
GM(2) = uipanel('Parent',ph_Main,...
    ...
    'Visible','off');
         ...
         GM(6) = uicontrol(GM(2),'Style','pushbutton',...
             ...
             'Callback','GroundMotions(''scale'')');
         GM(7) = axes('Parent',ph_Main,'Position',[0.12 0.45 0.35 0.15],'Box','on',...
             'Tag','a_GM_Xag','Visible','off','NextPlot','replacechildren');
             grid('on');
             xlabel(GM(7),'Time [sec]');
             ylabel(GM(7),'ag [L/sec^2]');
         GM(8) = axes('Parent',ph_Main,'Position',[0.12 0.25 0.35 0.15],'Box','on',...
             'Tag','a_GM_XSa','Visible','off','NextPlot','replacechildren','XTickLabel',[]);
             grid('on');
             ylabel(GM(8),'Sa [L/sec^2]');         
         GM(9) = axes('Parent',ph_Main,'Position',[0.12 0.08 0.35 0.15],'Box','on',...
...
GM(10) = uipanel('Parent',ph_Main,...
    ...
    'Visible','off');
         ...
         GM(14) = uicontrol(GM(10),'Style','pushbutton',...
             ...
             'Position',[0.33 0.01 0.4 0.15],...
             'Callback','GroundMotions(''scale'')');
         GM(15) = axes('Parent',ph_Main,'Position',[0.56 0.45 0.35 0.15],'Box','on',...
             'Tag','a_GM_Yag','Visible','off','NextPlot','replacechildren');
             grid('on');
             xlabel(GM(15),'Time [sec]');
             ylabel(GM(15),'ag [L/sec^2]');
         GM(16) = axes('Parent',ph_Main,'Position',[0.56 0.25 0.35 0.15],'Box','on',...
             'Tag','a_GM_YSa','Visible','off','XTickLabel',[],'NextPlot','replacechildren');
             grid('on');
             ylabel(GM(16),'Sa [L/sec^2]');         
         GM(17) = axes('Parent',ph_Main,'Position',[0.56 0.08 0.35 0.15],'Box','on',...
...
%Callback for main template tabs
    function template_toggle_Callback(source, eventdata)
        ...
        switch Page_selection;
            ...
            case 'Ground Motions'
                set(handles.Sidebar(8),'CData',handles.Store.sideButSelect);
                set(handles.Sidebar([7 9:11]),'CData',handles.Store.sideBut);
                ...
                elseif strcmp(handles.Model.Type, '2 DOF B') ~= 1
                    ...
                    set(handles.GroundMotions(2),'Position',[0.2 0.65 0.6 0.25]);
                    ...
                    set(handles.GroundMotions(2),'Position',[0.12 0.65 0.35 0.25]);
            ...
            case 'Experimental Setup'
                set(handles.Sidebar(9),'CData',handles.Store.sideButSelect);
                set(handles.Sidebar([7:8 10:11]),'CData',handles.Store.sideBut);
                set(handles.Structure,'Visible','off');
                set(handles.GroundMotions,'Visible','off');
                set(get(handles.GroundMotions(7), 'Children'), 'Visible', 'off');
                set(get(handles.GroundMotions(8), 'Children'), 'Visible', 'off');
            ...
            case 'Experimental Control'
                set(handles.Sidebar(10),'CData',handles.Store.sideButSelect);
                set(handles.Sidebar([7:9 11]),'CData',handles.Store.sideBut);
                set(handles.Structure,'Visible','off');
                set(handles.GroundMotions,'Visible','off');
                set(get(handles.GroundMotions(7), 'Children'), 'Visible', 'off');
            ...
            case 'Analysis'
                set(handles.Sidebar(11),'CData',handles.Store.sideButSelect);
                set(handles.Sidebar(7:10),'CData',handles.Store.sideBut);
                set(handles.Structure,'Visible','off');
                set(handles.GroundMotions,'Visible','off');
                set(get(handles.GroundMotions(7), 'Children'), 'Visible', 'off');
                set(get(handles.GroundMotions(8), 'Children'), 'Visible', 'off');
