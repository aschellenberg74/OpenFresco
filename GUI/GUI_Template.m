...
Background = axes('Parent',Struct(2),'Position',[0 0 1 1]);
imagesc(imread('greyGradient.png'));
% imagesc(imread('Metal.jpg'));
set(Background,'XTick',[],'YTick',[]); 
...
GM(2) = uipanel('Parent',ph_Main,...
    ...
    'Visible','off');
         ...
         GM(6) = uicontrol(GM(2),'Style','pushbutton',...
             ...
             'Callback','GroundMotions(''scale'')');
         GM(7) = axes('Parent',ph_Main,'Position',[0.15 0.45 0.35 0.15],'Box','on',...
             'Tag','a_GM_Xag','Visible','off','NextPlot','replacechildren');
             grid('on');
             xlabel(GM(7),'Time [sec]');
             ylabel(GM(7),'ag [L/sec^2]');
         GM(8) = axes('Parent',ph_Main,'Position',[0.15 0.25 0.35 0.15],'Box','on',...
             'Tag','a_GM_XSa','Visible','off','NextPlot','replacechildren','XTickLabel',[]);
             grid('on');
             ylabel(GM(8),'Sa [L/sec^2]');         
         GM(9) = axes('Parent',ph_Main,'Position',[0.15 0.08 0.35 0.15],'Box','on',...
...
GM(10) = uipanel('Parent',ph_Main,...
    ...
    'Visible','off');
         ...
         GM(14) = uicontrol(GM(10),'Style','pushbutton',...
             ...
             'Position',[0.33 0.01 0.4 0.15],...
             'Callback','GroundMotions(''scale'')');
         GM(15) = axes('Parent',ph_Main,'Position',[0.6 0.45 0.35 0.15],'Box','on',...
             'Tag','a_GM_Yag','Visible','off','NextPlot','replacechildren');
             grid('on');
             xlabel(GM(15),'Time [sec]');
             ylabel(GM(15),'ag [L/sec^2]');
         GM(16) = axes('Parent',ph_Main,'Position',[0.6 0.25 0.35 0.15],'Box','on',...
             'Tag','a_GM_YSa','Visible','off','XTickLabel',[],'NextPlot','replacechildren');
             grid('on');
             ylabel(GM(16),'Sa [L/sec^2]');         
         GM(17) = axes('Parent',ph_Main,'Position',[0.6 0.08 0.35 0.15],'Box','on',...
